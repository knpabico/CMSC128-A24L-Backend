...
const serviceAccount = {
  ...
  client_x509_cert_url:
    "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40cmsc-128-a24l.iam.gserviceaccount.com",
  universe_domain: "googleapis.com",
};
...
export { serverFirestoreDB, serverAuth, adminStorage };
>>>>>>> origin/backend-events
