    ...
    <div className="flex flex-col gap-5">
      <div className="w-full">
        <div className="flex items-center justify-between">
          <div className="font-bold text-3xl">Donation Drive</div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="bg-white flex flex-col justify-between rounded-2xl overflow-hidden w-full p-4">
          ...
          <div className="rounded-xl overflow-hidden border border-gray-300 overflow-y-auto">
            {/* Sticky header - will stick to top of scrollable container */}
            <div className="bg-blue-100 w-full flex gap-4 p-4 text-xs sticky top-0 z-10 shadow-sm">
              <div className="w-1/3 flex items-center justify-baseline font-semibold">
                Donation Drive Info
              </div>
            ...
            {donationDrives.map((drive, index) => (
              ...
              >
                <div className="w-1/3 flex flex-col p-4 gap-1">
                  <div className="text-base font-bold">{drive.title}</div>
                  <div className="text-sm text-gray-600">{drive.details}</div>
                </div>
                <div className="w-2/3 flex items-center justify-end p-5">
                  <div className="w-1/6 flex items-center justify-center">
                    <div className="bg-[var(--primary-blue)] rounded-full p-1 flex w-fit">
                      <div className="bg-white rounded-full w-5 h-5"></div>
                      <div className="bg-[var(--primary-blue)] rounded-full w-5 h-5"></div>
                    </div>
                  </div>
                  <div className="w-1/6 flex items-center justify-center">
                    <div className="text-blue-500 hover:underline cursor-pointer">View Details</div>
                  </div>
                  <div className="w-1/6 flex items-center justify-center">
