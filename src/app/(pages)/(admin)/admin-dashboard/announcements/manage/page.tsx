...
export default function ManageAnnouncements() {
  ...
  useEffect(() => {
    ...
    if (typeFilter !== "all") {
      filtered = filtered.filter((announcement) => {
        if (!announcement.type || !Array.isArray(announcement.type))
          return false;
        ...
        return announcement.type.some((type) =>
          matchingTypes.some(
            (matchType) => type.toLowerCase() === matchType.toLowerCase()
          )
        );
      });
    }
  ...
  return (
    <div className="flex flex-col gap-5">
      <title>Manage Announcements | ICS-ARMS</title>
      <Breadcrumb items={breadcrumbItems} />

      <div className="w-full">
        <div className="flex items-center justify-between">
          <div className="font-bold text-3xl">Manage Announcements</div>
          <button
            onClick={() => {
              router.push("/admin-dashboard/announcements/add");
              handleAddClick();
      ...
      <div className="bg-white rounded-xl flex gap-3 p-2.5 pl-4 items-center">
        ...
        <div className="relative">
          <div
            ...
            className={`border-2 border-[var(--primary-blue)] text-[var(--primary-blue)] pl-4 pr-2 py-2 rounded-full flex gap-1 items-center justify-between font-medium cursor-pointer  ${
        ...
        <div className="relative">
          <div
            ...
            className={`text-[var(--primary-blue)] border-2 border-[var(--primary-blue)] pl-4 pr-2 py-2 rounded-full flex gap-1 items-center justify-between text-sm font-medium cursor-pointer hover:bg-gray-400 ${
              typeFilter !== "all" ? "bg-blue-100 text-blue-700" : ""
            }`}
                      ...
                      <div className="w-1/2 flex items-center justify-end pr-1 p-5">
                        <div className="w-1/6 flex items-center justify-center">
                          <div className="flex flex-col items-center">
                            <button
                              onClick={async () => {
                                const result = await togglePublic(
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (
                                ...
                                toastSuccess(
                                  `You have successfully deleted announcement.`
                                );
