...
export default function AddAnnouncement() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <title>Edit Announcement | ICS-ARMS</title>
                ...
                <div className="flex space-x-6">
                  <label className="ml-2 block text-sm flex items-center gap-2">
                    <input
                      ...
                      onChange={() =>
                        isEditing && handleCheckbox("Donation Update")
                      }
                  ...
                  <label className="ml-2 block text-sm flex items-center gap-2">
                    <input
                      ...
                      onChange={() =>
                        isEditing && handleCheckbox("Event Update")
                      }
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"
                      disabled={!isEditing}
                    />
                  ...
                  <label className="ml-2 block text-sm flex items-center gap-2">
                    <input
                      ...
                      onChange={() =>
                        isEditing && handleCheckbox("General Announcement")
                      }
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"
                      disabled={!isEditing}
                    />
