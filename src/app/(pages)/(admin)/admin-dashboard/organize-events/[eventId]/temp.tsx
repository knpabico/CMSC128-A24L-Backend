...
export default function EventPageAdmin()
{
    ...
    useEffect(() =>
    {
        ...
        {
            const eventsToFetch = filteredEvents.filter(event =>
                event.creatorType === "alumni" && !creatorNames[event.eventId]
            );
    ...
    return (
        <div className="container mx-auto p-6">
            <h1 className="text-3xl font-bold mb-6 text-gray-800">Events Management</h1>
                {/* Filter Buttons */}
                <div className="mb-6">
