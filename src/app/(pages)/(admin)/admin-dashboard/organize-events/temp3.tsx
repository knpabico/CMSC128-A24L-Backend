      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="bg-white rounded-xl flex gap-3 p-2.5 pl-4 items-center">
          ...
          <div className="relative">
            {" "}
            {/* Added a wrapper for positioning */}
            <select
              id="sort"
              value={sortBy}
        ...
        <div className="bg-white flex flex-col justify-between rounded-2xl overflow-hidden w-full p-4">
          ...
          >
            ...
            >
              ...
              <div className="w-1/8 flex justify-left items-center font-semibold">
                {" "}
                Details{" "}
              </div>
              <div className="w-[2000px]"></div>
              <div className="w-1/2 flex justify-left items-center font-semibold">
                {" "}
                Status{" "}
              </div>
              <div className="w-1/2 flex justify-end items-center">
                <div className="w-[450px] flex items-center justify-center font-semibold">
                  Actions
                </div>
            ...
            {filteredEvents.length === 0 ? (
              <p className="w-1/2 flex flex-col p-4 text-gray-500">
                No Events found.
              </p>
            ) : (
              <>
