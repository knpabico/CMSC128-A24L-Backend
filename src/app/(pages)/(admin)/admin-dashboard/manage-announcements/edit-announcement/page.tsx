...
export default function AddAnnouncement() {
  ...
  // Sync the image preview with context on component mount
  useEffect(() => {
    const syncImagePreview = async () => {
      // If there's an image URL in context, set it as preview
          ...
          <div className="bg-white flex flex-col justify-between rounded-2xl overflow-hidden w-full p-4">
            ...
            <div className="bg-white rounded-2xl p-4 flex justify-end gap-2">
              ...
              <button
                ...
                onClick={() => {alert("Announcement post succesfully updated!")}}
                >
                Update
              </button>
            </div>
