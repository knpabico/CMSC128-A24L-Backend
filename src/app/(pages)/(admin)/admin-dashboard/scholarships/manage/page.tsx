...
export default function ManageScholarship(){
	...
	const navigateToDetail = (scholarshipId: string) => {
		router.push(`/admin/scholarships/manage/${scholarshipId}`);
	}
  ...
  useEffect(() => {
	...
	const create = () => {
    router.push("/admin/scholarships/add");
  };
								...
								<div className="">
									...
									>
										...
										<div className="w-1/2 flex items-center justify-end p-5">
												...
												<div className="flex flex-col items-center">
													<button
														...
														className={`relative inline-flex items-center h-6 rounded-full w-11 focus:outline-none ${
															scholarship.status !== "closed" ? "bg-blue-500" : "bg-gray-300"
														}`}
													>
											...
											<div className="w-1/6 flex items-center justify-center">
												<button className="text-[var(--primary-blue)] hover:underline cursor-pointer text-sm" onClick={() => navigateToDetail(scholarship.scholarshipId)}>View Details</button>
											</div>
											<div className="w-1/6 flex items-center justify-center">
