      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="w-full">
          <div className="flex items-center justify-between">
            <div className="font-bold text-3xl text-gray-800">Events Statistical Reports</div>
        ...
        <div className="mb-2 space-y-8 bg-white rounded-xl shadow-sm p-8 border border-gray-100">
          <h2 className="text-xl font-bold mb-6 text-gray-800 border-b pb-2 border-gray-100">Events Charts</h2>
          ...
          <CardHeader className="pb-3 border-b border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                {!eventLoading && (
                  <div className="text-[#0856BA] font-medium text-sm mt-1">Events with RSVPs: {eventsRSVPs.length}</div>
                )}
              </div>
              <div className="bg-[#0856BA] text-white rounded-full h-10 w-10 flex items-center justify-center">
                {eventsRSVPs.length}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <Card className="bg-white rounded-xl shadow-sm border-none ring-1 ring-gray-100 hover:ring-[#0856BA]/20 transition-all mb-2">
          <CardHeader className="pb-2 border-b border-gray-100">
            <CardTitle className="text-xl font-bold text-gray-800">Event Calendar</CardTitle>
          </CardHeader>
