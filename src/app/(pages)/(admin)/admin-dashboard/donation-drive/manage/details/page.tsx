    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="w-full">
        <div className="flex items-center justify-between">
          <div className="font-bold text-3xl">{campaignName}</div>
          {!isEditing && (
            <div
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="space-y-2">
              ...
              {beneficiary.map((beneficiaries: string, index: number) => (
                <div key={index} className="flex justify-between my-1">
                  ...
                  {beneficiary.length > 1 && (
                    <button
                      type="button"
                      className="px-4 py-2 text-gray-700 rounded-md hover:cursor-pointer"
              ...
              {isEditing && (
                <button
                  type="button"
                  className="px-1 my-3 text-blue-500 rounded-md flex gap-3 hover:cursor-pointer w-fit"
            ...
            <div className="space-y-1 flex justify-around my-1">
              ...
              <div className="text-start flex flex-col gap-3">
                {(preview || mainPhoto) && (
                  <div className="space-y-1">
                    <p className="text-sm font-medium flex items-center justify-center gap-3 py-2">
                      Background Photo Preview:
                    </p>
                    <img
                      src={preview ? preview : mainPhoto}
                ...
                {isEditing && (
                  <>
                    <label
                      ...
                      className="text-sm font-medium flex items-center cursor-pointer justify-center gap-3 py-2"
                    >
              ...
              <div className="text-start flex flex-col gap-3">
                {(previewGcash || qrGcash) && (
                  <div className="space-y-1">
                    <p className="text-sm font-medium flex items-center cursor-pointer justify-center gap-3 py-2">
                      Gcash QR Code Preview:
                    </p>
                    <img
                      src={previewGcash ? previewGcash : qrGcash}
                      alt="Uploaded Preview"
                      style={{ width: "200px", borderRadius: "8px" }}
                    />
                  </div>
              ...
              <div className="text-start flex flex-col gap-3">
                {(previewPaymaya || qrPaymaya) && (
                  <div className="space-y-1">
                    <p className="text-sm font-medium flex items-center cursor-pointer justify-center gap-3 py-2">
                      Paymaya QR Code Preview:
                    </p>
                    <img
                      src={previewPaymaya ? previewPaymaya : qrPaymaya}
                      alt="Uploaded Preview"
                      style={{ width: "200px", borderRadius: "8px" }}
                    />
                  </div>
            ...
            {isEditing && (
              <div
                ref={placeholderRef}
                className="bg-white rounded-2xl p-4 flex justify-end gap-2"
              >
                <button
                  type="button"
