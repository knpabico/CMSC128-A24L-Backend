...
const EventSidebar = () =>
{
    ...
    [
        ...
        { id: 'saved', label: 'Saved Events', href: '/donationdrive-list/saved', icon: Bookmark},
        { id: 'proposed', label: 'Proposed Events', href: '/donationdrive-list/proposed', icon: FileText},
        { id: 'donations', label: 'Invitations', href: 'events/invitations', icon: Mailbox},
