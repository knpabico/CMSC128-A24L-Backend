...
const AnnouncementPage = () => {
  ...
  return (
    <div className="px-[10%] py-10 flex flex-col bg-[#eaeaea]">
      ...
      <Link
        href="/announcement"
        className="mb-4 items-center flex gap-2 text-blue-600 hover:underline cursor-pointer transition-all"
      >
      ...
      <div className="rounded-[10px] bg-[#FFFFFF]">
        {announcement?.image === "" ? (
          ...
          <img src={announcement?.image} className="h-full w-full" />
        )}
      ...
      {randomAnnouncements.length > 0 && (
        <div className="flex flex-col gap-[10px] mb-[50px] mt-15">
          <p className="place-self-center text-[24px] font-semibold mt-8">
                ...
                <div className="grid grid-col rounded-[5px] w-[200px] lg:w-[300px] h-[300px] bg-[#FFFFFF] gap-[10px] shadow-sm overflow-hidden transition-all hover:shadow-md">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    {item.description.length > 70 ? (
                      <p className="text-xs px-5 text-justify whitespace-pre-wrap">
