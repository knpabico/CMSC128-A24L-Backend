...
export default function Home() {
  ...
  function adminHeader(announcement) {
    ...
    const authorPic = announcement.authorImage && announcement.authorName !== "admin" 
      ? announcement.authorImage 
      : "/ics-logo.jpg";
    
    // Use announcement author's name if available, fallback to ICS
    const authorName = announcement.authorName && announcement.authorName !== "admin" 
                              ...
                              return jobOffering
                                ...
                                (alums.find(
                                    ...
                                    alums.find(
                                      (alum: Alumnus) =>
                                        alum.alumniId === jobOffering.alumniId
                                    )?.lastName ): "Institute of Computer Science") 
