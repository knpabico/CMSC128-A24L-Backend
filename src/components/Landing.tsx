...
export default function Landing() {
	return (
		<div>
			<div className="w-screen fixed top-0 z-99">
			...
			<div className="bg-white h-screen w-full flex flex-col items-center justify-center gap-8 pt-20 overflow-hidden relative">
				{/* <div className="circlePosition w-[800px] h-[600px] bg-[var(--blue-100)] rounded-full absolute z-1 top-[80%] left-[20%] translate-x-[-50%] translate-y-[-50%] blur-[200px]"></div> */}
				...
				{/* Heading */}
				<div className={`${oswald.className} text-6xl text-[var(--blue-600)] relative z-10`}>
